...
const dummyUser2 = {
  ...
  encryptedMasterKey: {
    cipher:
      "V8IxebySc2ewpIC/iA+pL8GfdbETlpX+patr1h7h4dFo9RySzMV0+AJT5ajtfPV0Bb96X0JhF22DBaX2KBb9yh/RMj+3IP0Ve4HDbKTK9kY=",
  ...
  recoveryKeyData: {
    encryptedRecoveryMasterKey: {
      cipher:
        "G44sGd7YdwxXJt3DnK5utCiWtkbbvHGNYaBnneye6cUQdMV6rEj5E/98gs/9hEh2pQrTMpaey96gSCbMzHYKLfeOFkvWGY4WKn7lYKKuA4Q=",
      mac: "2b83df62bfb7d8a018162f1a48df99b017e0ed478b598e72f99f224280ebcdf6",
      nonce: "dd1f92c6511bc113172dfdcf73c5f5b9",
    },
    mnemonic:
      "demise avoid chicken sock memory rural pumpkin copper jar orbit wheel ready arrest hill depend puppy fence salad knee practice olympic need peanut essay",
  },
  rk_salt: "29ee70e7b0df8b44ec6f53f389e497a0",
};

const exampleEncryptedMasterKey =
  "2afc902920edd3500cc2f1a4f97432e21001b7e97ade482f648b06afe0b314f8";

const Index = () => {
  const [showSwipe, setShowSwipe] = React.useState(true);
  const colorScheme = useColorScheme();
  const settingsRef = React.useRef<BottomSheet>(null);
          ...
          <View className="flex-1 justify-end">
            <View className="w-full rounded-3xl p-6 bg-white/90 dark:bg-[#1f1f1f]/90 backdrop-blur-md shadow-2xl">
              ...
              <Text className="text-center text-gray-600 dark:text-gray-400 mt-2 mb-8 leading-relaxed">
                Store, protect, and access your data with military-grade
                encryption using SafeRaho.
              </Text>
